Helply is a mobile app that allows users (people in need) to send a help request, and from another side, allows helpers (volunteers) contribute and run users errands.
