...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVerificationField = findViewById(R.id.fieldPhoneNumber);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                Log.d("TAGtesthelpers", document.getId() + " => " + document.getData());
                                if (mAuth.getCurrentUser().getUid().equals(document.getData().get("userId").toString())) {
                                    isHelper = true;
                                }
                            ...
                            Log.w("TAGtesthelpers", "Error getting documents.", task.getException());
                        }
                    }
                });
    }
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                ((TextView) findViewById(R.id.textView2)).setText("Enter your code:");
                mPhoneNumberField.setHint(R.string.hint_verification_code);
                enableViews(mVerifyButton, mPhoneNumberField, mPhoneNumberField, mVerificationField);
